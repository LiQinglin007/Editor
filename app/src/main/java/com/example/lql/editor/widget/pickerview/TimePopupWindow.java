package com.example.lql.editor.widget.pickerview;
...
import com.example.lql.editor.widget.pickerview.lib.ScreenInfo;
import com.example.lql.editor.widget.pickerview.lib.WheelTime;
...
public class TimePopupWindow extends PopupWindow implements OnClickListener {
     ...
     * @param END_MONTH
     */
    public static void setMonth(int END_MONTH){
        WheelTime.setEND_MON(END_MONTH);
    }
     ...
     * @param END_DAY
     */
    public static void setDay(int END_DAY){
     ...
     * @param cyclic
     */
    public static void setCyclic(boolean cyclic) {

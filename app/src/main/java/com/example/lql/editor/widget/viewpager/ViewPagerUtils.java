...
public class ViewPagerUtils {
    ...
    public ViewPagerUtils(List<GetImglist.DataBean> pagerAdvertsList, Context context, final ViewPager advertViewPager, final PagerIndicator pagerIndicator) {
    ...
    public void setAdvers() {
        List<GetImglist.DataBean> pagerAdvertsListData = new ArrayList<>();
        ...
        AdvertScrollAdapter adapter = new AdvertScrollAdapter(context, advertViews, pagerAdvertsListData);
